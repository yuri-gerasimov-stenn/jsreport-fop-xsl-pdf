        ...
        return fs.writeFileAsync(xmlFilePath, request.data.data).then(function () {
          ...
          return new Promise(function (resolve, reject) {
            childProcess.exec(cmds.join(' '), {
              ...
              response.headers['Content-Type'] = 'application/' + outType
              response.headers['File-Extension'] = outType
              response.headers['Content-Disposition'] = 'inline; filename="' + outName + '.' + outType + '"'
